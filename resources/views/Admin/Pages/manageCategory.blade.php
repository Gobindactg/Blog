...
<div style="border: 2px solid teal; margin:5px; padding:5px;" class="overflow-auto">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <a href="#" class="btn btn-info mb-2">Manage Category</a>
            </div>
            <div class="col-md-6">
                <a href="{{route('category')}}" class="btn btn-primary mb-2" style="float: right;"><i style="font-size:15px" class="fa">&#xf067;</i> Add Category</a>
            </div>
        </div>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu pl-1 mt-2" aria-labelledby="dropdownMenuButton">
                            <a href="javascript:void(0)" class="btn btn-info" style="width: 47%;" onclick="updateBlog({{ $categorys->id}})">Edit</a>
                            <a href="javascript:void(0)" class="btn btn-danger" style="width: 47%;" onclick="deleteBlog({{ $categorys->id }})">delete</a>
                        </div>
                    </div>
                </td>
            </tr>
